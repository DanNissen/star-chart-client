...
var createAccomplishment = function createAccomplishment(data) {
...
var getAccomplishments = function getAccomplishments() {
  // console.log('user is', store.user.email)
  return $.ajax({
    method: 'GET',
    url: config.apiUrl + '/accomplishments',
...
var deleteAccomplishment = function deleteAccomplishment(data) {
...
var updateAccomplishment = function updateAccomplishment(data, id) {
...
var accomplishmentEvents = __webpack_require__(15);
...
var onInfoButton = function onInfoButton() {
  authUi.infoButton();
};
...
var infoButton = function infoButton(response) {
  $('#message-modal').modal('show');
...
var getFormFields = __webpack_require__(4);
var accomplishmentApi = __webpack_require__(6);
var accomplishmentUi = __webpack_require__(16);

var onCreateAccomplishment = function onCreateAccomplishment(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  // console.log('data is', data)
  accomplishmentApi.createAccomplishment(data).then(accomplishmentUi.createAccomplishmentSuccess).catch(accomplishmentUi.createAccomplishmentError);
};

var onGetAccomplishments = function onGetAccomplishments(event) {
  event.preventDefault();
  accomplishmentApi.getAccomplishments().then(accomplishmentUi.getAccomplishmentsSuccess).catch(accomplishmentUi.getAccomplishmentsError);
};

var onDeleteAccomplishment = function onDeleteAccomplishment(event) {
  event.preventDefault();
  var data = $(event.target).data('id');
  // console.log('id is', data)
  accomplishmentApi.deleteAccomplishment(data).then(accomplishmentUi.deleteAccomplishmentSuccess).catch(accomplishmentUi.deleteAccomplishmentError);
};

var onUpdateAccomplishment = function onUpdateAccomplishment(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var id = $(event.target).data('id');
  // console.log('data is', data)
  // console.log('id is', id)
  accomplishmentApi.updateAccomplishment(data, id).then(accomplishmentUi.updateAccomplishmentSuccess).catch(accomplishmentUi.updateAccomplishmentError);
};

var onResetAccomplishmentForms = function onResetAccomplishmentForms() {
...
module.exports = {
  onCreateAccomplishment: onCreateAccomplishment,
  onGetAccomplishments: onGetAccomplishments,
  onDeleteAccomplishment: onDeleteAccomplishment,
  onUpdateAccomplishment: onUpdateAccomplishment,
  onResetAccomplishmentForms: onResetAccomplishmentForms
  // onResetUpdateForms
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var showAccomplishmentsTemplate = __webpack_require__(17);
var accomplishmentApi = __webpack_require__(6);

var createAccomplishmentSuccess = function createAccomplishmentSuccess(response) {
  ...
  accomplishmentApi.getAccomplishments().then(getAccomplishmentsSuccess).catch(getAccomplishmentsError);
};

var createAccomplishmentError = function createAccomplishmentError(response) {
  $('#create-accomplishment-form')[0].reset();
...
var getAccomplishmentsSuccess = function getAccomplishmentsSuccess(data) {
  ...
  if (Object.keys(data).length === 0) {
    ...
    var showAccomplishmentsHtml = showAccomplishmentsTemplate({ days: data });
    $('.view-accomplishments').empty();
    $('.view-accomplishments').append(showAccomplishmentsHtml);
  }
};

var getAccomplishmentsError = function getAccomplishmentsError(response) {
...
var deleteAccomplishmentSuccess = function deleteAccomplishmentSuccess(response) {
...
var deleteAccomplishmentError = function deleteAccomplishmentError(response) {
...
var updateAccomplishmentSuccess = function updateAccomplishmentSuccess(response) {
  // console.log(response)
  var key = response.accomplishment.date_accomplished;
...
var updateAccomplishmentError = function updateAccomplishmentError(response) {
  $('.update-accomplishment-form')[0].reset();
...
var resetAccomplishmentForms = function resetAccomplishmentForms() {
  $('#create-accomplishment-form')[0].reset();
};
...
module.exports = {
  createAccomplishmentSuccess: createAccomplishmentSuccess,
  createAccomplishmentError: createAccomplishmentError,
  getAccomplishmentsSuccess: getAccomplishmentsSuccess,
  getAccomplishmentsError: getAccomplishmentsError,
  deleteAccomplishmentSuccess: deleteAccomplishmentSuccess,
  deleteAccomplishmentError: deleteAccomplishmentError,
  updateAccomplishmentSuccess: updateAccomplishmentSuccess,
  updateAccomplishmentError: updateAccomplishmentError,
  resetAccomplishmentForms: resetAccomplishmentForms
  // resetUpdateForms
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <li><a data-toggle=\"tab\" href=\"#accomplishment-"
  ...
  return "    <div id=\"accomplishment-"
    ...
    + "\" class=\"tab-pane fade accomplishment-view\">\n"
    + ((stack1 = helpers.each.call(alias1,blockParams[0][0],{"name":"each","hash":{},"fn":container.program(4, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </div>\n";
  ...
  return "        <div class=\"row\">\n          <div class=\"col-xs-7 col-sm-7 col-md-7 col-lg-7 col-xl-7\">\n            <span class=\""
    ...
    + " type=\"button\" class=\"btn btn-primary btn-sm\" data-toggle=\"modal\" data-target=\".update-accomplishment-modal-lg-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Update</button>\n            <button data-id= "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " type=\"button\" class=\"accomplishment-delete-button btn btn-primary btn-sm\" data-toggle=\"modal\" data-target=\".delete-accomplishment-modal-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete</button>\n          </div>\n        </div>\n";
},"6":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),blockParams[0][0],{"name":"each","hash":{},"fn":container.program(7, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"7":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "    <!-- delete accomplishment modal -->\n    <div id=\"delete-accomplishment-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"accomplishment-modal-handlebars accomplishment-modal delete-accomplishment modal delete-accomplishment-modal-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"deleteAccomplishment\" aria-hidden=\"true\">\n      <div class=\"modal-dialog modal-lg\">\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <h3 class=\"modal-title\">&#9734; Are you sure you want to Delete?! &#9734;</h3>\n            <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n                <span aria-hidden=\"true\">&times;</span>\n              </button>\n          </div>\n          <form data-id= "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " class=\"delete-accomplishment-form\">\n            <div class=\"modal-body\">\n              <!-- delete button -->\n              <button data-id= "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " type=\"submit\" class=\"btn btn-primary\">Yes, delete</button>\n            </div>\n          </form>\n        </div>\n      </div>\n    </div>\n";
},"9":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),blockParams[0][0],{"name":"each","hash":{},"fn":container.program(10, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"10":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "    <!-- update accomplishment modal -->\n    <div id=\"update-accomplishment-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"accomplishment-modal-handlebars update-accomplishment modal update-accomplishment-modal-lg-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"updateAccomplishment\" aria-hidden=\"true\">\n      <div class=\"modal-dialog modal-lg\">\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <h3 class=\"modal-title\">&#9734; Update Your Accomplishment! &#9734;</h3>\n            <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n                <span aria-hidden=\"true\">&times;</span>\n              </button>\n          </div>\n          <div class=\"modal-body\">\n            <!-- update accomplishment form -->\n            <form id=\"update-accomplishment-form-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"update-accomplishment-form\" data-id= "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ">\n              <div class=\"form-group\">\n                <label for=\"nameInput2\">Accomplishment Name</label>\n                <input name=\"accomplishment[name]\" type=\"text\" class=\"form-control\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\">\n              </div>\n              <div class=\"form-group\">\n                <label for=\"descriptionTextarea2\">Decription</label>\n                <input type=\"text\" name=\"accomplishment[description]\" class=\"form-control\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
    + "\">\n              </div>\n              <div class=\"form-group\">\n                <label for=\"dateInput2\">Date Accomplished - Is "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date_accomplished : stack1), depth0))
    + " still correct?</label>\n                <input value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date_accomplished : stack1), depth0))
    + "\" name=\"accomplishment[date_accomplished]\" type=\"date\" class=\"form-control\" >\n              </div>\n              <div class=\"form-group\">\n                <label for=\"colorSelect2\">Star Color is "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.color : stack1), depth0))
    + ", do you want to change that?</label>\n                <select value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.color : stack1), depth0))
    + "\" name=\"accomplishment[color]\" class=\"form-control\">\n                      <option>Red</option>\n                      <option>Blue</option>\n                      <option>Green</option>\n                      <option>Yellow</option>\n                      <option>Purple</option>\n                    </select>\n              </div>\n              <button data-id= "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " type=\"submit\" class=\"update-accomplishment btn btn-primary\">Update Accomplishment</button>\n            </form>\n          </div>\n        </div>\n      </div>\n    </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=depth0 != null ? depth0 : (container.nullContext || {});

  return "<ul class=\"nav nav-tabs accomplishment-tab\">\n"
    ...
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.days : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</div>\n\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.days : depth0),{"name":"each","hash":{},"fn":container.program(6, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.days : depth0),{"name":"each","hash":{},"fn":container.program(9, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = __webpack_require__.p + "91facf9543f04c6aaf1c80b7eb240b9d.png";
